...
const Uploadfile = () => {
  ...
  const handleSuggestionClick = (suggestion) => {
    ...
    const columnIndex = headers.indexOf(selectedDropdownColumn);
    const filteredIndex = data.findIndex(
      (row) =>
        String(row[columnIndex]).toLowerCase() === suggestion.toLowerCase()
    );
        ...
        <div className="main-content">
          ...
          <div className="right-panel">
            ...
            <div className="generate-payroll-container">
              <button className="download-button" onClick={downloadAndSave}>
                Save
              </button>
            </div>
            <div>
